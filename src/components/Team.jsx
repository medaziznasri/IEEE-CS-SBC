          ...
          <div className="img1">
            ...
            <div className="contact-overlay">
              ...
              <a className="contact-item" href="mailto:rayen@ieee.org">
                ...
                <div className="contact-text">rayen@ieee.org</div>
              </a>
              
              <a className="contact-item linkedin-item" href="https://www.linkedin.com/in/mohamed-rayen-ourabi" target="_blank" rel="noopener noreferrer">
                <span className="icon-container">
          ...
          <div className="img1">
            ...
            <div className="contact-overlay">
              ...
              <a className="contact-item" href="mailto:amir@ieee.org">
                ...
                <div className="contact-text">amir@ieee.org</div>
              </a>
          ...
          <div className="img1">
            ...
            <div className="contact-overlay">
              ...
              <a className="contact-item" href="mailto:ahmedyassine@ieee.org">
                ...
                <div className="contact-text">ahmedyassine@ieee.org</div>
              </a>
          ...
          <div className="img1">
            ...
            <div className="contact-overlay">
              ...
              <a className="contact-item" href="mailto:dali@ieee.org">
                ...
                <div className="contact-text">dali@ieee.org</div>
              </a>
          ...
          <div className="img1">
            ...
            <div className="contact-overlay">
              ...
              <a className="contact-item" href="mailto:aya@ieee.org">
                ...
                <div className="contact-text">aya@ieee.org</div>
              </a>
