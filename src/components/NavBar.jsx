...
import ParticlesComponent from "../components/Particles"; // Change to absolute path
        ...
        <div className="menu-container" ref={menuRef}>
          ...
          {isOpen && (
            <div className="menu-panel" id="menu-panel">
              ...
              <h1 className="navigation">navigations</h1>
              <ul>
                <li onClick={() => handleMenuOptionClick("/")}>
                  <a>Home</a>
                </li>
              ...
              <a className="join-us-menu-nav" target="_blank">
                <span className="join-us-text">Join us</span>
                <span className="join-us-icon">&gt;</span>
                <span className="join-us-particles"></span>
                <span className="join-us-glow"></span>
